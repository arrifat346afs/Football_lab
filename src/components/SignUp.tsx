      ...
      <form
        ...
        <div className="p-8 pb-6">
          <div>
            ...
            <h1 className="mb-1 mt-4 text-xl font-semibold">Create a Football Lab Account</h1>
            <p className="text-sm">Join Football Lab and never miss a moment</p>
          </div>
